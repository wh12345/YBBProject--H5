...
+ function($) {
  ...
  Select.prototype.initConfig = function() {
    ...
    this.tpl = $.t7.compile("<div class='weui-picker-modal weui-select-modal'>" + (config.multi ? config.checkboxTemplate : config.radioTemplate) + config.toolbarTemplate + "</div>");
  ...
  defaults = $.fn.select.prototype.defaults = {
    ...
    toolbarTemplate: '<div class="toolbar">\
      <div class="toolbar-inner">\
      <h class="title close-select">{{closeText}}</h1>\
      </div>\
      </div>',
    radioTemplate:
